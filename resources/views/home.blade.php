        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active position-relative">
                <video class="video-bg" autoplay loop muted playsinline>
                    <source src="{{ asset('storage/videos/carousel1.mp4') }}" type="video/mp4">
                </video>
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            @include('components.product-card', ['product' => $featuredGame, 'showDescription' => true])
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="carousel-item position-relative">
                <video class="video-bg" autoplay loop muted playsinline>
                    <source src="{{ asset('storage/videos/lolTrailer.mp4') }}" type="video/mp4">
                </video>
                <div class="overlay" style="background-color: rgba(0,0,0,0.5);"></div>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item position-relative">
                <video class="video-bg" autoplay loop muted playsinline>
                    <source src="{{ asset('storage/videos/wukongTrailer.mp4') }}" type="video/mp4">
                </video>
                @php
...
#videoCarousel {
    width: 100vw;
    height: 100vh; /* phủ toàn màn hình */
    position: relative;
    overflow: hidden;
